    ...
    <div className="min-h-screen p-4 sm:p-8 font-[family-name:var(--font-geist-sans)] bg-gray-950 text-white relative">
      ...
      <header className="flex flex-col gap-6 w-full max-w-6xl mx-auto mt-12 mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
          {/* Host Wallet */}
          <div className="bg-gray-900/50 p-3 rounded-lg border border-gray-800 flex justify-between items-center cursor-pointer hover:border-green-500/50 transition-colors" onClick={() => copyToClipboard(wallet.connected && wallet.publicKey ? wallet.publicKey.toString() : demoHostWallet.publicKey.toString(), "Host Address")}>
          ...
          {/* Agent Wallet */}
          <div className="bg-gray-900/50 p-3 rounded-lg border border-gray-800 flex justify-between items-center cursor-pointer hover:border-blue-500/50 transition-colors" onClick={() => copyToClipboard(agentWallet.publicKey.toString(), "Agent Address")}>
            <div className="flex flex-col">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 border-t border-gray-800 pt-8 order-4">
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
              AI Agents are the new economic actors, but they face a critical barrier: <span className="text-white font-medium"> Friction</span>.
              Standard crypto payments (gas fees, block times) are too slow and expensive for machine-to-machine commerce.
            </p>
            <div className="bg-red-900/10 p-4 rounded-lg border border-red-900/30">
              ...
              <p className="text-sm text-gray-400">
                Traditional &quot;Gasless&quot; solutions (EVM Paymasters) are broken for high-frequency use cases.
                They abstract gas, but <span className="text-white font-bold">someone still pays L2 fees</span> for every transaction.
                This makes $0.001 micro-payments economically impossible.
              </p>
            </div>
            <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-800">
              <h4 className="font-bold text-blue-400 mb-2">The PayStream Solution</h4>
              <p className="text-sm text-gray-300">
                PayStream utilizes <span className="text-white">Ephemeral Rollups</span> to achieve <span className="text-white font-bold">True Zero-Marginal-Cost</span>.
                We move the state off-chain, enabling thousands of micro-transactions per second with literally zero gas cost.
              </p>
            </div>
          </div>
